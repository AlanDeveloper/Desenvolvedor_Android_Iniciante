...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void verifyPresence() {
        String presence = this.mSecurityPreferences.getStoredString(FestaFimDeAno.PRESENCE_KEY);

        if(presence.equals("")) {
            this.mViewHolder.buttonConfirm.setText(getString(R.string.nao_confirmado));
        } else if(presence.equals(FestaFimDeAno.CONFIRMATION_YES)) {
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.button_confirm) {
            ...
            intent.putExtra(FestaFimDeAno.PRESENCE_KEY, presence);
